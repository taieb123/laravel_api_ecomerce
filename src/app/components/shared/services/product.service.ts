...
const API_URL: string = 'http://cocanasa.local/server';
...
export class ProductService {
  ...
  private apitoken;
  Token : string = 'e7LgzUwfOHYW2FiQrfYY32FtHnlFfDr2ktcwP8ZypPfURpil4bmcv4L8Y5ek'
  ...
  private products(): Observable<Product[]> {
    return this.httpClient.get<Product[]>(API_URL+'/api/v1/products',this.httpOptions);
